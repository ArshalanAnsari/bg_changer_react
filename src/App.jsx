  ...
  return (
    ...
    >
      <div className='fixed flex flex-wrap justify-center bottom-12 px-2 inset-x-0'>
        <div className='flex flex-wrap justify-center bg-white rounded-3xl px-3 py-2 gap-3 shadow-lg'>
          <button className='px-4 py-1 text-white rounded-full shadow-lg'
          ...
          <button className='px-4 py-1 text-black rounded-full shadow-lg'
